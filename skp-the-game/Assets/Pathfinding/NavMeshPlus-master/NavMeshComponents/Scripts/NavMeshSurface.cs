...
namespace NavMeshPlus.Components {
    ...
    public class NavMeshSurface : MonoBehaviour {
        [SerializeField, NavMeshAgent] int m_AgentTypeID;
        ...
        [SerializeField, NavMeshArea] int m_DefaultArea;
        ...
        [SerializeField] bool m_HideEditorLogs;

        public bool hideEditorLogs {
            get { return m_HideEditorLogs; }
            set { m_HideEditorLogs = value; }
        }

        // Reference to whole scene navmesh data asset.
        [UnityEngine.Serialization.FormerlySerializedAs("m_BakedNavMeshData")] [SerializeField]
